...
import Localizcao from './screen/Localizcao'
    ...
    <NavigationContainer>
      <Stack.Navigator>
        ...
        />
          <Stack.Screen
          name="Casinha"
          component={Localizcao}
          options={{ title: "Casinha" }}
        />
      </Stack.Navigator>
    </NavigationContainer>
  );
...
const HomeScreen = ({ navigation }) => {
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <TouchableOpacity
        style={styles.buttonNavegar}
        onPress={() => navigation.navigate("Casinha")}
      >
        <Image
          source={require('./src/img/casinha.png')}
          style={styles.logo2}
        />
        <Text style={styles.buttonText}>Casinha do Rafael</Text>
      </TouchableOpacity>
    </ScrollView>
  );
};
